    ...
    <footer className="bg-slate-900 text-slate-300 pt-16 pb-6 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 mb-10">
          ...
          <div>
            <h4 className="font-bold text-white mb-4 text-sm">{t('footer.navigation')}</h4>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/ressources?type=COURSE" className="hover:text-primary-400 transition">{t('resource.type')}</Link></li>
              ...
              <li><Link href="/ressources?type=BAC_SUBJECT" className="hover:text-primary-400 transition">{t('footer.bacSubjects')}</Link></li>
              ...
              <li>
                <Link href="/referentiel-national" className="hover:text-primary-400 transition inline-flex items-center gap-1.5">
                  ...
                  <span>{t('footer.referentiel')}</span>
                </Link>
              </li>
          ...
          <div>
            <h4 className="font-bold text-white mb-4 text-sm">{t('footer.about')}</h4>
            <ul className="space-y-2 text-sm">
